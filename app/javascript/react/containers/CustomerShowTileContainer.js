  ...
  render() {
    ...
    return (<div className="customer-show grid-x messages-container">
      <div className="cell small-3 callout-diary-creatio grid-y">
        <CustomerDashboard customerInfo={this.state.current_customer} currentUser={this.state.designated_user} handleReload={this.handleReload} selectedDiary= {this.state.selectedDiary}/>
      </div>
