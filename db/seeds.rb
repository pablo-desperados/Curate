...
Diary.create!(customer_id: customer1.id, title: 'Found something interesting', body: 'We actually worked at the same company years ago, this might be something to bring up in our next meeting', favorite: true, user_id: user0.id)
